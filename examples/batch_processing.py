...
- 30-column (v1.6.0) Phase7 OHLC schema with dual spreads, normalized metrics, timezone/session tracking, holiday tracking, and 10 global exchange sessions with trading hour detection
"""
